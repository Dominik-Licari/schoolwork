...
public class TextLab11st
{
	public static void main(String args[]) throws IOException
	{
		...
		int studentID = getID();
		int index = studentArray.binSearch(studentID);
...
class List
{
	...
	public void display(String listInfo)
	{
		...
		for (int k = 0; k < size; k++)
                        if (student[k] != null)
                                System.out.printf("%6d%25s%12d%13.3f%n", student[k].id, student[k].name, student[k].age, student[k].gpa);
	}
	...
	public void gpaSort()
	{
                for (int i = 0; i < student.length; i++)
                        for (int j = 1; j < student.length-i; j++)
                                if (student[j] == null)
                                        continue;
                                else if(student[j-1].gpa < student[j].gpa)
                                        swap(j-1, j);
	...
	public void ageSort()
	{
                for (int i = 0; i < student.length; i++)
                        for (int j = 1; j < student.length-i; j++)
                                if (student[j] == null)
                                        continue;
                                else if (student[j-1].age > student[j].age)
                                        swap(j-1, j);
        }
	...
	public void idSort()
	{
                for (int i = 0; i < student.length; i++)
                        for (int j = 1; j < student.length-i; j++)
                                if (student[j] == null)
                                        continue;
                                else if(student[j-1].id > student[j].id)
                                        swap(j-1, j);
	}

	public int linSearch(int studentID)
	{
                for (int i = 0; i < student.length; i++)
        ...
        public int binSearch(int studentID)
	{
